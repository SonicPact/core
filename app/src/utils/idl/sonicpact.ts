export const IDL = {
  ...
  instructions: [
    ...
    {
      name: "complete_deal",
      discriminator: [121, 16, 6, 239, 208, 68, 140, 61],
      accounts: [
        {
          name: "deal",
          writable: true,
        ...
        },
        {
          ...
          docs: ["Studio token account to receive the NFT"],
          writable: true,
        },
        {
          name: "nft_metadata",
          docs: ["NFT metadata account"],
          writable: true,
        },
        {
          name: "token_program",
    ...
    {
      name: "fund_deal",
      discriminator: [8, 26, 74, 169, 132, 56, 104, 60],
      accounts: [
        {
          name: "deal",
          writable: true,
